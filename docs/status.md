...
- PIM operations: `VADD`, experimental `ATTEND`, `DOT`, `MAC`, and 14-bit `ACC`; one shared PU is multiplexed between both channels, and INT8 compute is reserved for area
...
- Python model/example tests: 25 pass, 0 fail
- Cocotb TinyTapeout-wrapper RTL tests from `test/`: 11 pass, 0 fail
- Latest local synthesis checkpoint: 1902 cells, total mapped area 30696.4350, lint-clean on this experimental branch

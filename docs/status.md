...
- PIM operations: experimental `ATTEND`, `DOT`, `MAC`, and 8-bit `ACC`; one shared PU is multiplexed between both channels, while INT8 compute and the generic `VADD` slot are reserved for area
...
- Latest local synthesis checkpoint: 1665 cells, total mapped area 28541.0034, lint-clean on this experimental branch

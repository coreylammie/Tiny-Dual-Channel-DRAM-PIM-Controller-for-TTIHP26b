...
- PIM operations: `VADD`, experimental `KVUPD`, `DOT`, `MAC`, and 14-bit `ACC`; one shared PU is multiplexed between both channels, and INT8 compute is reserved for area
...
- Latest local synthesis checkpoint: 1886 cells, total mapped area 31074.4350, lint-clean on this experimental branch

...
| 1x1-attend-explicit-ref-int4only | 64b | explicit REF only, INT2 compute reserved | 1514 | 262 | TBD | TBD | synthesis-only, experimental | Reserves INT2 compute while preserving explicit `REF`, two channels, two banks/channel, INT1/INT4 DOT/MAC, and accumulator-fed INT4 `ATTEND`. INT2 tensors can still be represented in software and promoted to INT4 execution. LibreLane/Yosys synthesis is lint-clean. Area is 25579.1844, down 1108.2582 from the explicit-REF INT2/INT4 compute candidate. |
